...
var checksumMap = map[string]string{
	"./release/devpod-provider-yandexcloud-linux-amd64":       "##CHECKSUM_LINUX_AMD64##",
	"./release/devpod-provider-yandexcloud-linux-arm64":       "##CHECKSUM_LINUX_ARM64##",
	"./release/devpod-provider-yandexcloud-darwin-amd64":      "##CHECKSUM_DARWIN_AMD64##",
	"./release/devpod-provider-yandexcloud-darwin-arm64":      "##CHECKSUM_DARWIN_ARM64##",
	"./release/devpod-provider-yandexcloud-windows-amd64.exe": "##CHECKSUM_WINDOWS_AMD64##",
}
